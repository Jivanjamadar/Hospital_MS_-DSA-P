...
# AVL : For efficient insertion, deletion & search opr.( O(nlogn)) also as it self balancing ( rotation)
...
class HospitalManagementSystem:
    ...
    def search_patient(self, patient_id):
        return self.avl.search(self.avl.root, patient_id)
